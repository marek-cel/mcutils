...
template <typename T>
void MatrixMxN_CanGetDimensionless()
{
    mc::MatrixMxN<T,ROWS,COLS> m1;
...
TEST_F(TestMatrixMxNWithUnits, GetDimensionless)
{
    MatrixMxN_CanGetDimensionless<units::moment_of_inertia::kilograms_meters_squared_t>();
}
...
template <typename T>
void MatrixMxN_CanMultiplyByScalarAngularVel()
{
...
TEST_F(TestMatrixMxNWithUnits, CanMultiplyByScalarAngularVel)
{
    MatrixMxN_CanMultiplyByScalarAngularVel<units::moment_of_inertia::kilograms_meters_squared_t>();
}

template <typename T>
void MatrixMxN_CanMultiplyByScalarAngularAcc()
{
...
TEST_F(TestMatrixMxNWithUnits, CanMultiplyByScalarAngularAcc)
{
    MatrixMxN_CanMultiplyByScalarAngularAcc<units::moment_of_inertia::kilograms_meters_squared_t>();
}
...
template <typename T>
void MatrixMxN_CanMultiplyMatrixByVectorAngularVel()
{
    std::vector<T> x
    {
        T{1}, T{2}, T{3},
    ...
    mc::VectorN<units::angular_velocity::radians_per_second_t,ROWS> v;
    v(0) = 1.0_rad_per_s;
    v(1) = 2.0_rad_per_s;
    v(2) = 3.0_rad_per_s;
...
TEST_F(TestMatrixMxNWithUnits, CanMultiplyMatrixByVectorAngularVel)
{
    MatrixMxN_CanMultiplyMatrixByVectorAngularVel<units::moment_of_inertia::kilograms_meters_squared_t>();
}

template <typename T>
void MatrixMxN_CanMultiplyMatrixByVectorAngularAcc()
{
    std::vector<T> x
    {
        T{1}, T{2}, T{3},
    ...
    mc::VectorN<units::angular_acceleration::radians_per_second_squared_t,ROWS> v;
...
TEST_F(TestMatrixMxNWithUnits, CanMultiplyMatrixByVectorAngularAcc)
{
    MatrixMxN_CanMultiplyMatrixByVectorAngularAcc<units::moment_of_inertia::kilograms_meters_squared_t>();
}
...
template <typename T>
void MatrixMxN_CanMultiplyScalarByMatrixAngularVel()
{
    constexpr units::angular_velocity::radians_per_second_t val = 2.0_rad_per_s;
...
TEST_F(TestMatrixMxNWithUnits, CanMultiplyScalarByMatrixAngularVel)
{
    MatrixMxN_CanMultiplyScalarByMatrixAngularVel<units::moment_of_inertia::kilograms_meters_squared_t>();
}

template <typename T>
void MatrixMxN_CanMultiplyScalarByMatrixAngularAcc()
{
    constexpr units::angular_acceleration::radians_per_second_squared_t val = 2.0_rad_per_s_sq;
...
TEST_F(TestMatrixMxNWithUnits, CanMultiplyScalarByMatrixAngularAcc)
{
    MatrixMxN_CanMultiplyScalarByMatrixAngularAcc<units::moment_of_inertia::kilograms_meters_squared_t>();
}
